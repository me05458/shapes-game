...
# settings
The settings file has a bunch of numbers in it. Right now, the settings file needs to be directly modified (will be changed soon!). Change the number after the word.
...
- colors/blocks currently hardcoded
